...
/**
 * IRoleCommand objects execute most of the game logic. They are generated
 * anonymously by the functions in AbstractRole and children of the AbstractRole.
 * <br>
 * IRoleCommand objects are generally executed by the GameManager. They accept
...
public interface IRoleCommand {
    ...
    /**
     * Call this method to perform the operation encapsulated by this IRoleCommand object. The
     * intent is that IRoleCommand objects perform all of the in-game operations on the model. This
     * excludes game setup.
     * <br>
     ...
     */
    ICommandResult execute(/*GameModel model*/);
